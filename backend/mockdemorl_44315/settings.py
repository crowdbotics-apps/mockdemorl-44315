"""
Django settings for mockdemorl_44315 project.
...
ROOT_URLCONF = 'mockdemorl_44315.urls'
...
WSGI_APPLICATION = 'mockdemorl_44315.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "mockdemorl_44315 API",
    "DESCRIPTION": "API documentation for mockdemorl_44315 App",
    "VERSION": "v1",
}
